...
namespace Jolt.Testing.Harness.DotNetFramework.Newtonsoft
{
    public sealed class TransformationTests : TransformerTests
    {
        ...
        [TransformerTest(Transformer.SingleLevelValueOf, SourceDocument.SingleLevel, typeof(TestContext), TestType.Newtonsoft)]
        ...
        [TransformerTest(Transformer.MultiLevelValueOf, SourceDocument.MultiLevel, typeof(TestContext), TestType.Newtonsoft)]
        ...
        [TransformerTest(Transformer.Loops, SourceDocument.Loop, typeof(TestContext), TestType.Newtonsoft)]
        ...
        [TransformerTest(Transformer.Existence, SourceDocument.Existence, typeof(TestContext), TestType.Newtonsoft)]
        ...
        [TransformerTest(Transformer.PipedMethods, SourceDocument.PipedMethods, typeof(TestContext), TestType.Newtonsoft)]
        ...
        [TransformerTest(Transformer.ExternalMethods, SourceDocument.ExternalMethods, typeof(TestContext), TestType.Newtonsoft, typeof(ExternalInstanceMethods))]
        ...
        [TransformerTest("ExternalMethodsWithAliases", "ExternalMethodsDocument", typeof(TestContext), TestType.Newtonsoft, typeof(ExternalMixedMethods))]
        ...
        [TransformerTest(Transformer.RangeVariables, SourceDocument.Loop, typeof(TestContext), TestType.Newtonsoft)]
        ...
        [TransformerTest(Transformer.Lambdas, SourceDocument.Lambdas, typeof(TestContext), TestType.Newtonsoft)]
        ...
        [TransformerTest(Transformer.UsingBlock, SourceDocument.Loop, typeof(TestContext), TestType.Newtonsoft)]
